...
checkpoint = torch.load('./model_chkps/model_chkp.pth')
...
dataset = ListDataset(root='/data/deva/recaptcha_data/labelled',
                       list_file=['/data/deva/recaptcha_data/labelled/dataset_train.txt'],
                       transform=transform)

dataloader = torch.utils.data.DataLoader(dataset, batch_size=12, shuffle=False, num_workers=2)
